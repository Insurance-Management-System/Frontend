...
export default function AdminPolicies(){
    ...
    return(
        <div>
            <PageHeader title="Policy Plans"
            description="Create and manage insurance plans offered to customers."
            action={<button className="btn btn-primary d-flex align-items-center gap-2" onClick={openCreate}>
            ...
            <div className="row g-3">
                ...
                return (
                    ...
                    <div className="ag-card h-100 p-4 d-flex flex-column">
                        ...
                        <div className="ag-stat-icon ag-soft-icon">
                            <Icon size={22} />
                        </div>
                        ...
                        <div className="col-6">
                            ...
                            <p className="fw-semibold mb-0">{formatINR(policy.premium)}<span className="text-muted-2 fw-normal" style={{ fontSize: "0.72rem" }}>/{policy.duration}</span></p>
                        </div>
                        </div>
                        <button
          ...
          <div className="modal-content">
            <form onSubmit={submit}>
              ...
              <div className="modal-body d-flex flex-column gap-3">
                ...
                <div className="row g-3">
                  <div className="col-6">
                    <label className="form-label small fw-medium">Coverage (₹)</label>
                    <input type="number" className="form-control" value={form.coverage} onChange={(e) => update("coverage", e.target.value)} required />
                  </div>
                  <div className="col-6">
                    <label className="form-label small fw-medium">Premium (₹)</label>
